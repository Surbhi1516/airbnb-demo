      ...
      <main>
        <section className='flex-grow pt-14 px-6'>
          ...
          <div className='hidden lg:inline-flex mb-5 space-x-3 text-gray-800 whitespace-nowrap' >
            <p className='text-gray-500 px-4 py-2 text-xl bg-gray-50 rounded-full  cursor-pointer  hover:shadow-lg   active:scale-95 active:bg-gray-100 transition duration-150 hover:border ease-out'>Cancellation Flexibility</p>
            <p className='text-gray-500 px-4 py-2 text-xl bg-gray-50 rounded-full  cursor-pointer  hover:shadow-lg   active:scale-95 active:bg-gray-100 transition duration-150 hover:border ease-out'>Type of Place</p>
